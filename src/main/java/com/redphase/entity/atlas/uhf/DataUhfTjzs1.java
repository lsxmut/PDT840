package com.redphase.entity.atlas.uhf;
...
/** <p> 特高频_模式1_统计噪声 entity */
public class DataUhfTjzs1 extends BaseEntity {
    /**
     * 主键
     */
    private Long id;
    ...
    private Integer x5;
    /**
     * |6|char|1字节|幅值单位表示幅值的单位dBm:0x01mV:0x02%:0x03
     */
    private Integer x6;
    /**
     * |7|float|4字节|幅值下限仪器所能检测到的放电信号幅值的下限。暂定：-75
     */
    private Float x7;
    /**
     * |8|float|4字节|幅值上限仪器所能检测到的放电信号幅值的上限。暂定：-10
     */
    private Float x8;
    /**
