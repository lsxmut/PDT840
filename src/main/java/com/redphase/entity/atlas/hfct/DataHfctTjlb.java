...
/** <p> 高频电流_统计录波 entity */
public class DataHfctTjlb extends BaseEntity {
    /**
     * 主键
     */
    private Long id;
    ...
    private Integer x6;
    /**
     * |7|char|1字节|幅值单位表示幅值的单位dB:0x01mV:0x02
     */
    private Integer x7;
    /**
    ...
    private Float x13;
    /**
     * |14|uint8|1字节|同步类型外同步:0x01内同步:0x02
     */
    private Integer x14;
    /**
     * |15|float|4字节|同步频率
    ...
    private Float x16;
    /**
     * |17|uint8|1字节|放大增益20dB:0x0140dB:0x0260dB:0x03
     */
    private Integer x17;
    /**
     * |18|int32|4字节|前置衰减以dB为单位
     */
    private Integer x18;
    /**
     * |19|float|4字节|警戒值1如50
     */
    private Float x19;
    /**
     * |20|float|4字节|警戒值2如150
     */
    private Float x20;
    /**
     * |21|float|4字节|警戒值3如200
     */
    private Float x21;
    /**
     * |22|uint8|1字节|频带
    ...
    private Float x24;
    /**
     * |25|char|32字节|仪器厂家从系统设置中提取，使用UNICODE编码。以0x0000结尾，例如：RedPhase。
     */
    private String x25;
    /**
     * |26|char|32字节|仪器型号从系统设置中提取，使用UNICODE编码。以0x0000结尾，例如：PDT-400。
     */
    private String x26;
    /**
     * |27|uint8|4字节|仪器版本号从系统设置中提取，所使用的数据格式规范版本号。版本号有4个部分，形如X.X.X.X。实例：版本号为1.0.0.0，数组元素[0]到[3]分别存储1、0、0、0四个数字。每个元素可以是整数0至255中的某数。
     */
    private String x27;
    /**
     * |28|char|32字节|仪器序列号从系统设置中提取，即仪器出厂编号，使用ASCII编码。以\0结尾，例如：S12300000000000000。
     */
    private String x28;
    /**
     * |29|int|4字节|检验和1到校验和前一项的数据校验。
     */
    private Integer x29;
    /**
     * 建立者ID
