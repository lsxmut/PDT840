package com.redphase.entity.atlas.hfct;
...
/** <p> 高频电流_统计噪声 entity */
public class DataHfctTjzs extends BaseEntity {
    /**
     * 主键
     */
    private Long id;
    ...
    private Integer x5;
    /**
     * |6|char|1字节|幅值单位表示幅值的单位dB:0x01mV:0x02
     */
    private Integer x6;
    /**
    ...
    private Integer x12;
    /**
     * |13|int32|4字节|数据长度数据项13到校验和的字节长度。
     */
    private Integer x13;
    /**
    ...
    private Long x14;
    /**
     * |15|uint8|1字节|检测技术类型编码标识该文件是采用什么技术获得。TEV:0x01AA:0x02AE:0x03HFCT:0x04UHF:0x05
     */
    private Integer x15;
    /**
    ...
    private Float x22;
    /**
     * |23|uint8|1字节|放大增益20dB:0x0140dB:0x0260dB:0x03
     */
    private Integer x23;
    /**
     * |24|int32|4字节|前置衰减以dB为单位
     */
    private Integer x24;
    /**
     * |25|float|4字节|警戒值1如50
     */
    private Float x25;
    /**
     * |26|float|4字节|警戒值2如150
     */
    private Float x26;
    /**
     * |27|float|4字节|警戒值3如200
     */
    private Float x27;
    /**
     * |28|uint8|1字节|频带
    ...
    private Float x30;
    /**
     * |31|char|32字节|仪器厂家从系统设置中提取，使用UNICODE编码。以0x0000结尾，例如：RedPhase。
     */
    private String x31;
    /**
     * |32|char|32字节|仪器型号从系统设置中提取，使用UNICODE编码。以0x0000结尾，例如：PDT-400。
     */
    private String x32;
    /**
     * |33|uint8|4字节|仪器版本号从系统设置中提取，所使用的数据格式规范版本号。版本号有4个部分，形如X.X.X.X。实例：版本号为1.0.0.0，数组元素[0]到[3]分别存储1、0、0、0四个数字。每个元素可以是整数0至255中的某数。
     */
    private String x33;
    /**
     * |34|char|32字节|仪器序列号从系统设置中提取，即仪器出厂编号，使用ASCII编码。以\0结尾，例如：S12300000000000000。
     */
    private String x34;
    /**
     * |35|int32|4字节|检验和13到校验和前一项的数据校验。
     */
    private Integer x35;
    /**
     * 建立者ID
