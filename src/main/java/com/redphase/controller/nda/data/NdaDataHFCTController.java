...
@FXMLController
@Slf4j
public class NdaDataHFCTController extends NdaBaseController implements Initializable {
    @FXML
    BorderPane dataBorderPane;
    @Autowired
    NdaSiteCountController ndaSiteCountController;
    @FXML
    Label typeL;//
    @FXML
    Label titleL;//标题
...
//                                    setXw("");// 相位
                                    ndaSiteCountController.init(testTechnology, hfctTableDto.getTjList(), null);
