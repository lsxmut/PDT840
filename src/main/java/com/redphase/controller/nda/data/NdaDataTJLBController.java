...
@FXMLController
@Slf4j
public class NdaDataTJLBController extends NdaBaseController implements Initializable {
    @FXML
    @Getter
    Pane mlayer;//蒙层
    @FXML
    ...
    private void loadAtlas(boolean flag) {
        try {
            if (flag) {
                ...
                rangeValue = 0;
                idialog.setTitle(ndaDataTJLBView, dataDeviceDto.getSubstation() + "," + dataDeviceDto.getDeviceName() + "," + dataDeviceSiteDto.getSiteName() + "," + dataTableDto.getCssj());
