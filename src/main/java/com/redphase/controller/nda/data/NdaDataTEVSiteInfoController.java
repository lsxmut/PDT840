...
@FXMLController
@Slf4j
public class NdaDataTEVSiteInfoController extends NdaBaseController implements Initializable {
    ...
    public void loadData() {
        try {
            DataDeviceDto subDataDeviceDto = (DataDeviceDto) ehcacheUtil.getCache(CommonConstant.NDA_DATA_SKILL_DEVICE_SITE);
