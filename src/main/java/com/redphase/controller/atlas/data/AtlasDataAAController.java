...
import com.redphase.view.atlas.data.AtlasDataAASiteInfoView;
...
@FXMLController
@Slf4j
public class AtlasDataAAController extends AtlasBaseController implements Initializable {
    @FXML
    ...
    @Autowired
    private AtlasDataAASiteInfoView atlasDataAASiteInfoView;
    @Autowired
    private AtlasDataAASiteInfoController atlasDataAASiteInfoController;
...
//                            Double height = Application.getStage().getHeight() - 100;
                            idialog.openDialog(tableDto.getDataDeviceDto().getDeviceName(), atlasDataAASiteInfoView, 1180.0, 700.0, true);
                            atlasDataAASiteInfoController.loadData(tableDto.getDataDeviceDto());
                        });
                    }
                }
            });
