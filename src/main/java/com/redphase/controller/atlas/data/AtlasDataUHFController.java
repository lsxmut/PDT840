...
@FXMLController
@Slf4j
public class AtlasDataUHFController extends AtlasBaseController implements Initializable {
    @FXML
                        ...
                        for (int i = 0; i < dataList.size(); i++) {
                            ...
                            add(new UhfListDto() {{
                                ...
                                if (uhfTableDto.getTj1List() != null && uhfTableDto.getTj1List().size() > 0) {
                                    atlasSiteCountController.init(testTechnology, uhfTableDto.getTj1List(), null);
