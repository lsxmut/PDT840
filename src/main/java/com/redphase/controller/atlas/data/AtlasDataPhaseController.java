...
@FXMLController
@Slf4j
public class AtlasDataPhaseController extends AtlasBaseController implements Initializable {
    @Autowired
    ...
    double xAtlasLength = xLength / atlasLenght;//1150像素等比{atlasPhaseLenght}份
    ...
    public void init(String testTechnology, Float[][] atlasArr, Map map) {
        ...
        //数据
        for (int i = 0; i < atlasLenght; i++) {
            double x1 = xZeroSpot + 10 + (i * xAtlasLength);
            double x2 = xZeroSpot + 10 + (i * xAtlasLength);
            double y1 = yZeroSpot;
