...
@FXMLController
@Slf4j
public class AtlasDataAEController extends AtlasBaseController implements Initializable {
    @FXML
...
//                                    idialog.openDialog(finalSubDataDeviceDto.getDeviceName() + "," + dataAeTableDto.getSite(), atlasDataSiteCountView, width, height);
