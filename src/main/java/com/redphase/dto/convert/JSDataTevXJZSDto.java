...
/** <p> 江苏_暂态地电压_电压幅值数据(噪声) DTO */
public class JSDataTevXJZSDto extends BaseDto {
    /**
    ...
    private Float x29;
    /**
     * 必备 float 4字节 暂态地电压幅值数据 - 暂态地电压幅值数据。
     */
    private Float x30;
    /**
     * 可选 float 4字节 暂态地电压幅值最大值 -
     */
    private Float x31;
    /**
     * 可选 int32 4字节 脉冲数 - 脉冲个数。
     */
    private Integer x32;
    /**
     * 可选 float 4字节 烈度 -
