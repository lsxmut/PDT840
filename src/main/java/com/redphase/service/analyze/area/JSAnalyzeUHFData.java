 ...
 */
@Slf4j
public class JSAnalyzeUHFData {
    /**
     * 江苏_特高频电流_PRPD图和PRPS图数据
     * 2.数据格式要求。
     * ---------------------------------------------------------------------------------------
     * |    序号  |  数据类型   |  长度        |  备注
     * ---------------------------------------------------------------------------------------
    ...
    public Object UHF_TJ(int i, byte[] dataBytes) throws Exception {
        ...
        switch (i + 1) {
            ...
            case 32://	float	4字节
                ...
                break;
            case 38://	d[m][n]或d[p][m]	k*m*n字节或k*p*m字节
     ...
     * ---------------------------------------------------------------------------------------
     */
    public Object UHF_TJZS(int i, byte[] dataBytes) throws Exception {
        Object data = null;
        switch (i + 1) {
            case 6://	uint8	1字节
            case 8://	int8	1字节
