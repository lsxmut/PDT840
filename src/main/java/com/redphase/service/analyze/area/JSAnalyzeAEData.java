...
public class JSAnalyzeAEData {
     ...
     * ---------------------------------------------------------------------------------------
     */
    public Object AE_BX(int i, byte[] dataBytes) throws Exception {
        Object data = null;
        switch (i + 1) {
            case 6:// uint8 1字节
            case 8:// int8 1字节
     ...
     * ---------------------------------------------------------------------------------------
     */
    public Object AE_FX(int i, byte[] dataBytes) throws Exception {
        Object data = null;
        switch (i + 1) {
            case 6:// uint8 1字节
            case 8:// int8 1字节
     ...
     * |	34	|	d[2*n]	|	k*2*n字节	|	超声相位图数据	-	根据存储数据类型t获取数据的存储方式。实例1：t是0x02，d表示uint8数组，k=1；实例2：t是0x04，d表示int32数组，k=4；实例3：t是0x06，d表示float数组，k=4。依次存储每个数据点的相位Phase和幅值Q，存储顺序：
     * |	35	|	-	|	32字节	|	预留	-	预留
     * |	36	|	int32	|	4字节	|	CRC32	-	数据校验，使用CRC32算法
     * ---------------------------------------------------------------------------------------
     */
    public Object AE_TJ(int i, byte[] dataBytes) throws Exception {
        Object data = null;
        switch (i + 1) {
            case 6:// uint8 1字节
            case 8:// int8 1字节
     ...
     * ---------------------------------------------------------------------------------------
     */
    public Object AE_TJZS(int i, byte[] dataBytes) throws Exception {
        Object data = null;
        switch (i + 1) {
            case 6:// uint8 1字节
            case 8:// int8 1字节
     ...
     * ---------------------------------------------------------------------------------------
     */
    public Object AE_XJ(int i, byte[] dataBytes) throws Exception {
        Object data = null;
        switch (i + 1) {
            case 6:// uint8 1字节
            case 8:// int8 1字节
     ...
     * ---------------------------------------------------------------------------------------
     */
    public Object AE_XJZS(int i, byte[] dataBytes) throws Exception {
        Object data = null;
        switch (i + 1) {
            case 6:// uint8 1字节
            case 8:// int8 1字节
