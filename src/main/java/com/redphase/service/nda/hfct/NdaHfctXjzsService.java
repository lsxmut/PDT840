...
import com.redphase.api.nda.hfct.INdaHfctXjzsService;
import com.redphase.dao.slave.nda.hfct.INdaHfctXjzsDao;
...
@Service
@Slf4j
public class NdaHfctXjzsService extends BaseService implements INdaHfctXjzsService {
    @Autowired
    private INdaHfctXjzsDao dataHfctXjzsDao;
