...
import com.redphase.api.nda.INdaLcService;
import com.redphase.dao.slave.nda.INdaLcDao;
...
@Service
@Slf4j
public class NdaLcService extends BaseService implements INdaLcService {
    @Autowired
    private INdaLcDao dataLcDao;
