...
import com.redphase.controller.nda.NdaController;
...
@Slf4j
public class NdaFileTask extends Task {
...
//    private Set<String> electricBureauPathSet = new HashSet<>();
    ...
    private NdaController ndaController;
    private IAccountService accountService;
    private IAccountSiteInfoService accountSiteInfoService;
    private INdaDeviceService dataDeviceService;
    private INdaDeviceSiteService dataDeviceSiteService;
    private INdaAnalyzeService dataAnalyzeService;
    private INdaHjService dataHjService;
    private INdaLcService dataLcService;
    private INdaAaBxService dataAaBxService;
    private INdaAaFxService dataAaFxService;
    private INdaAaTjlbService dataAaTjlbService;
    private INdaAaTjService dataAaTjService;
    private INdaAaTjzsService dataAaTjzsService;
    private INdaAaXjService dataAaXjService;
    private INdaAaXjzsService dataAaXjzsService;
    private INdaAeBxService dataAeBxService;
    private INdaAeFxService dataAeFxService;
    private INdaAeTjlbService dataAeTjlbService;
    private INdaAeTjService dataAeTjService;
    private INdaAeTjzsService dataAeTjzsService;
    private INdaAeXjService dataAeXjService;
    private INdaAeXjzsService dataAeXjzsService;
    private INdaHfctTjlbService dataHfctTjlbService;
    private INdaHfctTjService dataHfctTjService;
    private INdaHfctTjzsService dataHfctTjzsService;
    private INdaHfctXjService dataHfctXjService;
    private INdaHfctXjzsService dataHfctXjzsService;
    private INdaTevTjlbService dataTevTjlbService;
    private INdaTevTjService dataTevTjService;
    private INdaTevTjzsService dataTevTjzsService;
    private INdaTevXjService dataTevXjService;
    private INdaTevXjlhService dataTevXjlhService;
    private INdaTevXjzsService dataTevXjzsService;
    private INdaUhfTj1Service dataUhfTj1Service;
    private INdaUhfTj2Service dataUhfTj2Service;
    private INdaUhfTjlb1Service dataUhfTjlb1Service;
    private INdaUhfTjlb2Service dataUhfTjlb2Service;
    private INdaUhfTjzs1Service dataUhfTjzs1Service;
    private INdaUhfTjzs2Service dataUhfTjzs2Service;
    ...
    public NdaFileTask(Map map) {
        this.ndaController = (NdaController) map.get("ndaController");
        ...
        this.dataDeviceService = (INdaDeviceService) map.get("dataDeviceService");
        this.dataDeviceSiteService = (INdaDeviceSiteService) map.get("dataDeviceSiteService");
        this.dataAnalyzeService = (INdaAnalyzeService) map.get("dataAnalyzeService");
        this.dataHjService = (INdaHjService) map.get("dataHjService");
        this.dataLcService = (INdaLcService) map.get("dataLcService");
        this.dataTevTjService = (INdaTevTjService) map.get("dataTevTjService");
        this.dataTevTjlbService = (INdaTevTjlbService) map.get("dataTevTjlbService");
        this.dataTevTjzsService = (INdaTevTjzsService) map.get("dataTevTjzsService");
        this.dataTevXjService = (INdaTevXjService) map.get("dataTevXjService");
        this.dataTevXjlhService = (INdaTevXjlhService) map.get("dataTevXjlhService");
        this.dataTevXjzsService = (INdaTevXjzsService) map.get("dataTevXjzsService");
        this.dataAaBxService = (INdaAaBxService) map.get("dataAaBxService");
        this.dataAaFxService = (INdaAaFxService) map.get("dataAaFxService");
        this.dataAaTjService = (INdaAaTjService) map.get("dataAaTjService");
        this.dataAaTjlbService = (INdaAaTjlbService) map.get("dataAaTjlbService");
        this.dataAaTjzsService = (INdaAaTjzsService) map.get("dataAaTjzsService");
        this.dataAaXjService = (INdaAaXjService) map.get("dataAaXjService");
        this.dataAaXjzsService = (INdaAaXjzsService) map.get("dataAaXjzsService");
        this.dataAeBxService = (INdaAeBxService) map.get("dataAeBxService");
        this.dataAeFxService = (INdaAeFxService) map.get("dataAeFxService");
        this.dataAeTjService = (INdaAeTjService) map.get("dataAeTjService");
        this.dataAeTjlbService = (INdaAeTjlbService) map.get("dataAeTjlbService");
        this.dataAeTjzsService = (INdaAeTjzsService) map.get("dataAeTjzsService");
        this.dataAeXjService = (INdaAeXjService) map.get("dataAeXjService");
        this.dataAeXjzsService = (INdaAeXjzsService) map.get("dataAeXjzsService");
        this.dataHfctTjService = (INdaHfctTjService) map.get("dataHfctTjService");
        this.dataHfctTjlbService = (INdaHfctTjlbService) map.get("dataHfctTjlbService");
        this.dataHfctTjzsService = (INdaHfctTjzsService) map.get("dataHfctTjzsService");
        this.dataHfctXjService = (INdaHfctXjService) map.get("dataHfctXjService");
        this.dataHfctXjzsService = (INdaHfctXjzsService) map.get("dataHfctXjzsService");
        this.dataUhfTj1Service = (INdaUhfTj1Service) map.get("dataUhfTj1Service");
        this.dataUhfTj2Service = (INdaUhfTj2Service) map.get("dataUhfTj2Service");
        this.dataUhfTjlb1Service = (INdaUhfTjlb1Service) map.get("dataUhfTjlb1Service");
        this.dataUhfTjlb2Service = (INdaUhfTjlb2Service) map.get("dataUhfTjlb2Service");
        this.dataUhfTjzs1Service = (INdaUhfTjzs1Service) map.get("dataUhfTjzs1Service");
        this.dataUhfTjzs2Service = (INdaUhfTjzs2Service) map.get("dataUhfTjzs2Service");
    ...
    protected Object call() throws Exception {
        try {
            ...
            try {
                ...
                String dataFilePath = importPathText;
...
//                    String electricBureau;//电业局
                    ...
                    AccountDto accountDevice = new AccountDto();
                    accountDevice.setElectricBureau("数据目录");//电业局
...
//                    if (filePath.indexOf(File.separator + CommonConstant.NDA_DATA_DIR_NAME + File.separator) != -1) {
