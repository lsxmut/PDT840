...
import com.redphase.api.nda.ae.INdaAeBxService;
import com.redphase.dao.slave.nda.ae.INdaAeBxDao;
...
@Service
@Slf4j
public class NdaAeBxService extends BaseService implements INdaAeBxService {
    @Autowired
    private INdaAeBxDao dataAeBxDao;
