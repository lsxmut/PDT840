...
import com.redphase.api.nda.aa.INdaAaBxService;
import com.redphase.dao.slave.nda.aa.INdaAaBxDao;
...
@Service
@Slf4j
public class NdaAaBxService extends BaseService implements INdaAaBxService {
    @Autowired
    private INdaAaBxDao dataAaBxDao;
