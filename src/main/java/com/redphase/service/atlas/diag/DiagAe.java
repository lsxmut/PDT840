...
@Component
@Slf4j
public class DiagAe extends BaseDiag {

    public String getResult(double[] p) {
        String result = "数据源出错";
        try {
            //二分类权重
            double[] er_juzhen_0 = fopen("/AE/2class/ae_2class_A50_61.bin");
            double[] er_juzhen_1 = fopen("/AE/2class/ae_2class_B40_51.bin");
            double[] er_juzhen_2 = fopen("/AE/2class/ae_2class_C20_41.bin");
            double[] er_juzhen_3 = fopen("/AE/2class/ae_2class_D2_21.bin");
            double[] er_minn = fopen("/AE/2class/ae_2class_min.bin");
            double[] er_maxx = fopen("/AE/2class/ae_2class_max.bin");

            //四分类权重
            double[] juzhen_0 = fopen("/AE/4class/ae_x_4class_A80_61.bin");
            double[] juzhen_1 = fopen("/AE/4class/ae_x_4class_B50_81.bin");
            double[] juzhen_2 = fopen("/AE/4class/ae_x_4class_C4_51.bin");
            double[] minn = fopen("/AE/4class/ae_x_4class_min.bin");
            double[] maxx = fopen("/AE/4class/ae_x_4class_max.bin");
            ...
            a = read_data_erjin(juzhen_0, a, bias_1, DefineConstants.SIZE_1_1, DefineConstants.SIZE_1_2);

            b = read_data_erjin(juzhen_1, b, bias_2, DefineConstants.SIZE_2_1, DefineConstants.SIZE_2_2);

            c = read_data_erjin(juzhen_2, c, bias_3, DefineConstants.SIZE_3_1, DefineConstants.SIZE_3_2);
            ...
            if (pred_label_er == 1) {
                ...
                for (int num = 0; num < 1; num++) {
                    double sum_;
                    b_1 = matrixx(a, data_, b_1, DefineConstants.SIZE_1_1, DefineConstants.SIZE_1_2); // b_1 是200维
                    for (int i = 0; i < DefineConstants.SIZE_1_1; i++) {
                        b_1[i] = b_1[i] + bias_1[i];
                        b_1[i] = sigmoid(b_1[i]);
                    }

                    c_1 = matrixx(b, b_1, c_1, DefineConstants.SIZE_2_1, DefineConstants.SIZE_2_2); // c_1 是250维
                    ...
                    d_1 = matrixx(c, c_1, d_1, DefineConstants.SIZE_3_1, DefineConstants.SIZE_3_2); // d_1 是4维
                    ...
                    pred_label = max_i_(d_1, 4); // 4个类别


                    sum_ = d_1[0] + d_1[1] + d_1[2] + d_1[3];
                    d_1[0] = d_1[0] / sum_;
                    d_1[1] = d_1[1] / sum_;
                    d_1[2] = d_1[2] / sum_;
                    d_1[3] = d_1[3] / sum_;
    ...
    final class DefineConstants {
        ...
        public static final int SIZE_1_1 = 80;
        public static final int SIZE_1_2 = 60;
        public static final int SIZE_2_1 = 50;
        public static final int SIZE_2_2 = 80;
    ...
    public static void main(String[] args) {
        ...
        DiagAe ae = new DiagAe();
        System.out.println(ae.getResult(p));
    }
}
