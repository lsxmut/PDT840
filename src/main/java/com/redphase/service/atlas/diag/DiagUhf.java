...
@Component
@Slf4j
public class DiagUhf extends BaseDiag {
    public String getResult(double[] p) {
        String result = "数据源出错";
        try {
            //三分类权重
            double[] er_juzhen_0 = fopen("/UHF/3class/uhf_3class_A50_61.bin");
            double[] er_juzhen_1 = fopen("/UHF/3class/uhf_3class_B40_51.bin");
            double[] er_juzhen_2 = fopen("/UHF/3class/uhf_3class_C20_41.bin");
            double[] er_juzhen_3 = fopen("/UHF/3class/uhf_3class_D3_21.bin");
            double[] er_minn = fopen("/UHF/3class/uhf_3class_min.bin");
            double[] er_maxx = fopen("/UHF/3class/uhf_3class_max.bin");

            //五分类权重
            double[] juzhen_0 = fopen("/UHF/5class/uhf_x_5class_A100_61.bin");
            double[] juzhen_1 = fopen("/UHF/5class/uhf_x_5class_B50_101.bin");
            double[] juzhen_2 = fopen("/UHF/5class/uhf_x_5class_C5_51.bin");
            double[] minn = fopen("/UHF/5class/uhf_x_5class_min.bin");
            double[] maxx = fopen("/UHF/5class/uhf_x_5class_max.bin");
            ...
            for (int num = 0; num < 1; num++) {
                ...
                pred_label_er = max_i_(er_f_1, 3);  // 3个类别
    ...
    final class DefineConstants {
        public final static int sample_len = 60;
        public final static int erc_size_1_1 = 50;
        public final static int erc_size_1_2 = 60;
        public final static int erc_size_2_1 = 40;
        public final static int erc_size_2_2 = 50;
        public final static int erc_size_3_1 = 20;
        public final static int erc_size_3_2 = 40;
        public final static int erc_size_4_1 = 3;
        public final static int erc_size_4_2 = 20;
        public final static int SIZE_1_1 = 100;
        public final static int SIZE_1_2 = 60;
        public final static int SIZE_2_1 = 50;
        public final static int SIZE_2_2 = 100;
        public final static int SIZE_3_1 = 5;
        public final static int SIZE_3_2 = 50;
    }
    ...
    public static void main(String[] args) {
        ...
        DiagUhf uhf = new DiagUhf();
        System.out.println(uhf.getResult(p));
    }
}
