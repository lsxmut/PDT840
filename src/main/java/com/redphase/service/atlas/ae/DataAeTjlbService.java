...
import com.redphase.api.atlas.ae.IDataAeTjlbService;
import com.redphase.dao.master.atlas.ae.IDataAeTjlbDao;
...
@Service
@Slf4j
public class DataAeTjlbService extends AtlasService implements IDataAeTjlbService {
    @Autowired
    private IDataAeTjlbDao dataAeTjlbDao;
