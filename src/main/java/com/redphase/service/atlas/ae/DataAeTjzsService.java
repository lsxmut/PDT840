...
import com.redphase.dao.master.atlas.ae.IDataAeTjzsDao;
...
@Service
@Slf4j
public class DataAeTjzsService extends AtlasService implements IDataAeTjzsService {
    @Autowired
    private IDataAeTjzsDao dataAeTjzsDao;
