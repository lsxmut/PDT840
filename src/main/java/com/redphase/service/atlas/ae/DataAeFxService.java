...
import com.redphase.dao.master.atlas.ae.IDataAeFxDao;
...
@Service
@Slf4j
public class DataAeFxService extends AtlasService implements IDataAeFxService {
    @Autowired
    private IDataAeFxDao dataAeFxDao;
