...
import com.redphase.api.atlas.IDataHjService;
import com.redphase.dao.master.atlas.IDataHjDao;
...
@Service
@Slf4j
public class DataHjService extends AtlasService implements IDataHjService {
    @Autowired
    private IDataHjDao dataHjDao;
