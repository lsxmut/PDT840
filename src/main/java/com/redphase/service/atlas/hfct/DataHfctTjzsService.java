...
import com.redphase.dao.master.atlas.hfct.IDataHfctTjzsDao;
...
@Service
@Slf4j
public class DataHfctTjzsService extends AtlasService implements IDataHfctTjzsService {
    @Autowired
    private IDataHfctTjzsDao dataHfctTjzsDao;
