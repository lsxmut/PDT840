...
import com.redphase.dao.master.atlas.IDataDeviceDao;
...
@Service
@Slf4j
public class DataDeviceService extends BaseService implements IDataDeviceService {
    @Autowired
    private IDataDeviceDao dataDeviceDao;
